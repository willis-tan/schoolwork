...
def image_processing_test_examples():
    ...
    clockwise_dsc20_img = IP.rotate_90(dsc20_img, True)
    img_save("img/out/dsc20_clockwise.png", clockwise_dsc20_img)

    # rotate counterclockwise and save
    ccwise_dsc20_img = IP.rotate_90(dsc20_img, False)
    img_save("img/out/dsc20_ccwise.png", ccwise_dsc20_img)

    # crop and save
    crop_dsc20_img = IP.crop(dsc20_img, 50, 75, (75, 50))
    img_save("img/out/dsc20_cropped.png", crop_dsc20_img)
    print(crop_dsc20_img.size())
